...
for row in s_cursor:
    ...
    """Add SurveyBy value for Final Calcs"""
...
"""Corrected the below calc to be for Square Yards instead of square feet"""
...
"""Added Driveway Remove Only Dictionary"""
# Driveway Remove
...
# Create Final Calc Dictionaries 
cceNoCalcs = cceNo
...
for row in u_cursor:
    ...
    """Added the calcs for hydroseed and topsoil"""
    # Hydroseed SY
    ...
    """T3 curb removed from CORE calculation for Drill and Grout"""
    ...
    CICSubGranMatTypeB_ADA_CY = math.ceil(math.ceil((((((T3RL[pageNo]) + (T3ARL[pageNo])) * 2.58) / 9.0) * 0.25) / 3.0) + math.ceil(((((T4RL[pageNo]) * 1.5) / 9.0) * 0.5) / 3.0)) 
    ...
    # Pavement Markings (#117,#118,#121,#122) 
    ...
    """ **UPDATES PER REVISIONS """
    """T3RL no longer included for Surface Removal """
